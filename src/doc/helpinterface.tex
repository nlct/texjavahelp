...
\inlineglsdef{index.help-page}).  Links in the page and the \gls{gui} navigation
elements provide a way to switch to a different page.  Note that
\qt{page} in this context refers to the file displayed in the help
...
the symbol \gls[textformat=iconfmt]{manual.location_prefix}.
