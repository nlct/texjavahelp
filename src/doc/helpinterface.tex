...
\menudef{menu.helpframe.navigation.close}
...
\menudef{menu.helpdialog.navigation.close}
...
\figureref{fig:helpfontdialog}). 

\widgetdef{help_font_settings.family}

Use the \widget{help_font_settings.family} selector for the main body font
family.

\widgetdef{help_font_settings.size}

The \widget{help_font_settings.size} selector sets the size for the
main body font. 

\widgetdef{help_font_settings.icon_font_family}

Icon characters, such as
...
\widgetdef{help_font_settings.keystroke_font_family}

Use the \widget{help_font_settings.keystroke_font_family} selector to
choose the font to show keystrokes (such as
\keys{\keyref{shift}}).

\widgetdef{help_font_settings.mono_font_family}

The \widget{help_font_settings.mono_font_family} selector determines the
font to display code fragments (such as \verb|% \ { } #|).

\widgetdef{help_font_settings.hyperlinks} 
The document hyperlink style can be adjusted with the 
\widget{help_font_settings.hyperlinks} settings.

\widgetdef{help_font_settings.choose_colour} 

The \btn{help_font_settings.choose_colour} button opens a color
selector to select the text color.

\widgetdef{help_font_settings.underline}
Toggle the \btn{help_font_settings.underline} checkbox to enable or
disable underlining.
