...
public class PostSwitchHook extends AbstractGlsCommand
{
   public PostSwitchHook(GlossariesSty sty)
   {
      this("postswitchhook", sty);
   }

   public PostSwitchHook(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new PostSwitchHook(getName(), getSty());
   }
   ...
   throws IOException
   {
      ...
      if (entry != null)
      {
         ...
         TeXObject fieldVal = entry.get("syntax");
         ...
         fieldVal = entry.get("shortswitch");
         ...
         if (fieldVal != null)
         {
            ...
            list.add(listener.getLetter('o'));
            list.add(listener.getLetter('r'));
            list.add(listener.getControlSequence("space"));
