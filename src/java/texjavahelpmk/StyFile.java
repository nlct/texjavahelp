...
public class StyFile extends AbstractGlsCommand
{
   public StyFile(GlossariesSty sty)
   {
      this("styfile", sty);
   }

   public StyFile(String name, GlossariesSty sty)
   {
      super(name, sty);
   ...
   public Object clone()
   {
      return new StyFile(getName(), sty);
   }
