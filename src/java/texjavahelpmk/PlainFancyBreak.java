...
public class PlainFancyBreak extends ControlSequence
{
   public PlainFancyBreak()
   {
      this("plainfancybreak");
   }

   public PlainFancyBreak(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new PlainFancyBreak(getName());
   }
     ...
     throws IOException
   {
      ...
      popArg(parser, stack);// (space) ignore
