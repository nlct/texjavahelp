...
public class IdxWidgetPostNameHook extends AbstractGlsCommand
{
   public IdxWidgetPostNameHook(GlossariesSty sty)
   {
      this("idxwidgetpostnamehook", sty);
   }

   public IdxWidgetPostNameHook(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new IdxWidgetPostNameHook(getName(), getSty());
   }
   ...
   throws IOException
   {
      ...
      if (entry != null)
      {
         TeXObject keystrokeVal = entry.get("keystroke");
