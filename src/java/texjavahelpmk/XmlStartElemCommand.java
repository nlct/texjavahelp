...
public class XmlStartElemCommand extends AbstractGlsCommand
{
   public XmlStartElemCommand(GlossariesSty sty)
   {
      this("xmlStartElem", sty);
   }

   public XmlStartElemCommand(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new XmlStartElemCommand(getName(), sty);
   }
     ...
     throws IOException
   {
      ...
      TeXObject attrList = popArg(parser, stack);
