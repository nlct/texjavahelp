...
public class MnemonicTrail extends AbstractGlsCommand
{
   public MnemonicTrail(GlossariesSty sty)
   {
      this("mnemonictrail", sty);
   }

   public MnemonicTrail(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new MnemonicTrail(getName(), sty);
   }
   ...
   throws IOException
   {
      ...
      if (entry != null)
      {
         ...
         expanded.push(listener.getControlSequence("mnemonicitemref"));
