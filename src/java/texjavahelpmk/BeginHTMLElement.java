 ...
 * The first optional argument provides the element attributes.
 * The second optional argument is for LaTeX only.
 * The final argument is the element name.
 */
public class BeginHTMLElement extends Command
{
   public BeginHTMLElement()
   {
      this("BeginHTMLElement");
   }

   public BeginHTMLElement(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new BeginHTMLElement(getName());
   }
     ...
     throws IOException
   {
      ...
      StartElement startElem = new StartElement(elemName);
