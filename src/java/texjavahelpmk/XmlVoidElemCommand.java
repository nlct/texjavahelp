...
public class XmlVoidElemCommand extends AbstractGlsCommand
{
   public XmlVoidElemCommand(GlossariesSty sty)
   {
      this("xmlVoidElem", sty);
   }

   public XmlVoidElemCommand(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new XmlVoidElemCommand(getName(), sty);
   }
     ...
     throws IOException
   {
      ...
      TeXObject attrList = popOptArg(parser, stack);
